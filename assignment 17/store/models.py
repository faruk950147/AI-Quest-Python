...
class Product(ImageTagMixin):
    ...
    old_price = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal('1000.00'))
    sale_price = models.DecimalField(max_digits=20, decimal_places=2, default=Decimal('1000.00'))
...
class ProductVariant(ImageTagMixin):
    ...
    variant_price = models.DecimalField(max_digits=20, decimal_places=2)
