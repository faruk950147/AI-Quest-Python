...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('NONE', 'None'), ('LEHENGA', 'Lehenga'), ('SHAREE', 'Sharee'), ('GENT_PANTS', 'Gent Pants'), ('BORKHA', 'Borkha'), ('BABY_FASHION', 'Baby Fashion')], default='NONE', max_length=50)),
                ('keyword', models.CharField(default='N/A', max_length=150)),
                ('description', models.CharField(default='N/A', max_length=150)),
