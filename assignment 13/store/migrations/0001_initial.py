...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category_type', models.CharField(choices=[('NONE', 'None'), ('LEHENGA', 'Lehenga'), ('SHAREE', 'Sharee'), ('GENT_PANTS', 'Gent Pants'), ('BORKHA', 'Borkha'), ('BABY_FASHION', 'Baby Fashion')], default='NONE', max_length=50)),
                ('title', models.CharField(max_length=150, unique=True)),
                ('slug', models.SlugField(blank=True, max_length=150, null=True, unique=True)),
                ('keyword', models.CharField(blank=True, default='N/A', max_length=150)),
                ('description', models.CharField(blank=True, default='N/A', max_length=150)),
